    ...
    <div className="py-32 mb-12 lg:mb-20">
      <div className="px-6 lg:px-32">
        <h1 className="relative text-center text-2xl lg:text-3xl font-jost font-semibold text-neutral-800">
          <img
            src="https://cdn-icons-png.flaticon.com/512/7629/7629196.png"
            className="absolute -top-3 lg:top-3  left-[10%] lg:left-[30%] -translate-x-1/2 h-12"
            alt=""
          />
          <img
            src="https://cdn-icons-png.flaticon.com/512/7629/7629196.png"
            className="absolute -top-3 lg:top-3  right-[10%] lg:right-[30%] translate-x-1/2 h-12"
            alt=""
          />
          Trusted Brands
        </h1>
      ...
      <div className="mt-32">
        <Marquee speed={50}>
          <div className="h-32 w-32 lg:w-44 lg:h-44 bg-transparent shrink-0 mr-20">
            <img
          ...
          <div className="h-32 w-32 lg:w-44 lg:h-44 bg-transparent shrink-0 mr-20">
            <img
              src="https://fidele.co/cdn/shop/files/Asset_2_2x_0389ade8-5ff6-43eb-a12e-de3d44b66beb_250x.png?v=1632518116"
              alt=""
              className="h-full w-full object-contain"
            />
          </div>
