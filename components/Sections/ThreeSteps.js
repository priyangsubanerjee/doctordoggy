  ...
  return (
    <div className="bg-[#0d1121] py-16 lg:py-24 px-6 lg:px-28">
      ...
      <div className="mt-10 lg:flex items-center justify-center space-y-4 lg:space-y-0 lg:space-x-6">
        <button className="w-full lg:w-fit h-12 px-5 lg:px-10 bg-white rounded-md flex justify-center items-center space-x-4">
          <Icon height={24} icon="solar:calendar-broken" />
          <span>Schedule a service</span>
        </button>
        <button className="w-full lg:w-fit h-12 px-5 lg:px-10 text-white border border-white rounded-md flex justify-center items-center space-x-4">
