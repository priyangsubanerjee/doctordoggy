...
export const VaccinationDue = (due) => {
  return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
    ...
    <div class="container">
      <div class="messageBox">
        <h1 style="font-size: 25px; font-weight: 600; margin-top: 20px">
          Vaccinations due ${due}
        </h1>
        <p style="font-weight: 400; line-height: 1.9; margin-top: 30px">
          Gentle reminder
        </p>
        <p style="font-weight: 400; line-height: 1.9; margin-top: 10px">
          Your pet is <strong>due for vaccinations</strong> ${due}. Please visit
          your nearest vet to get the vaccinations done. <br />
          <br />
          If you have already got the vaccinations done, please update the same
          on the app. <br />
          <br />
        </p>
        <a
          ...
          "
        >
          <button class="button">Click here to update</button>
        </a>
...
export const VaccinationOverDue = () => {
  return `<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    <div class="container">
      <div class="messageBox">
        ...
        <p style="font-weight: 400; line-height: 1.9; margin-top: 10px">
          Your pet is <strong>overdue for vaccinations</strong>. Please visit
          your nearest vet to get the vaccinations done. <br />
          <br />
          If you have already got the vaccinations done, please update the same
          on the app. <br />
        ...
        <a
          href="https://doctordoggy.vet/vaccination?filter=due"
          style="
            margin-top: 15px;
            margin: 0 auto;
            width: fit-content;
  ...
  <body>
    <div class="container">
      <div class="messageBox">
        ...
        <p style="font-weight: 400; line-height: 1.9; margin-top: 10px">
          Your pet is <strong>due for deworming</strong> ${due}. Please follow the instructions given by your vet. <br />
          <br />
          If you have already done the dewormings done, please update the same
          on the app. <br />
          <br />
        </p>
        <a
  ...
  <body>
    <div class="container">
      <div class="messageBox">
        ...
        <p style="font-weight: 400; line-height: 1.9; margin-top: 10px">
          Your pet is <strong>overdue for deworming</strong>. Please follow the instructions given by your vet. <br />
          <br />
          If you have already done the dewormings, please update the same
          on the app. <br />
          <br />
        </p>
        <a
          href="https://doctordoggy.vet/deworming?filter=due"
          style="
            margin-top: 15px;
            margin: 0 auto;
            width: fit-content;
