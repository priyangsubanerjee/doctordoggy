...
function Dashboard() {
  return (
    <div className="min-h-screen px-6 py-8 lg:py-16 lg:px-[100px]">
      ...
      <button className="h-12 px-6 font-medium shadow-xl shadow-black/20 bg-neutral-800 text-white rounded-full text-sm fixed bottom-5 lg:bottom-14 right-6 lg:right-8 flex items-center space-x-3">
